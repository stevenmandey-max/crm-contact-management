...
import { ServiceExportModal } from '../services/ServiceExportModal';
        ...
        <div className="contact-detail-content">
            ...
            <div className="info-section">
              ...
              <div className="info-group">
                <div className="info-item">
                  ...
                  <div className="info-value">{contact.nama}</div>
                </div>
                
                <div className="info-item">
                  <label>Gender</label>
                  <div className="info-value">{contact.jenisKelamin || 'Not specified'}</div>
                </div>
                
                <div className="info-item">
                  <label>Religion</label>
                  <div className="info-value">{contact.agama}</div>
                </div>
              </div>
            </div>
            ...
            <div className="info-section">
              ...
              <div className="info-group">
                <div className="info-item">
                  ...
                  <div className="info-value">{contact.nomorTelepon || 'Not provided'}</div>
                </div>
                
                <div className="info-item">
                  <label>Address</label>
                  <div className="info-value address">{contact.alamat}</div>
                </div>
                
                <div className="info-item">
                  <label>Provinsi</label>
                  <div className="info-value">{contact.provinsi || 'Not specified'}</div>
                </div>
              </div>
            </div>

            <div className="info-section full-width">
              <h3>Contact Reason & Source</h3>
              <div className="info-group">
                <div className="info-item">
                  <label>Reason for Contact</label>
                  <div className="info-value reason">{contact.alasanMenghubungi}</div>
                </div>
            ...
            <div className="info-section">
              ...
              <div className="info-group">
                <div className="info-item">
                  ...
                  <div className="info-value">
                    <span className={`priority-badge priority-${contact.prioritas?.toLowerCase() || 'sedang'}`}>
                ...
                <div className="info-item">
                  ...
                  <div className="info-value">{getContactAge()}</div>
                </div>
              </div>
            </div>
          ...
          <div className="contact-metadata">
            <div className="metadata-item">
              <span className="metadata-label">Contact ID:</span>
              <span className="metadata-value">{contact.id}</span>
            </div>
            <div className="metadata-item">
              <span className="metadata-label">Created by:</span>
              <span className="metadata-value">{contact.createdBy}</span>
            </div>
          </div>
